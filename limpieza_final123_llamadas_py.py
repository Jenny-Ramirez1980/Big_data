{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyNE8EY6dcgWce0BLTr0SWjr",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Jenny-Ramirez1980/Big_data/blob/main/limpieza_final123_llamadas_py.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
      "source": [
        "Limpieza de datos 2021-2022 Llamadas 123"
      ],
      "metadata": {
        "id": "0QTJrPxCFP_9"
      }
    },
    {
      ...
      "source": [
        ...
        "root_dir = \"ggs://jramirez_llamadas_123\"\n",
        ...
        "    reporte.to_csv(\"gs://jramirez_llamadas_123/data/processed/\" + out_name,encoding =\"latin1\",sep=\";\")\n",
        "\n",
        "def main():\n",
        "\n",
        "    filename = \"Consolidado_datos_abiertos_2021_2022.csv\"\n",
